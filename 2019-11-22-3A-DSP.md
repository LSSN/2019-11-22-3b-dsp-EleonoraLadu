...
2019-11-22-3A-DSP.md.
### 01. CAMPIONAMENTO

##### 1.1 Descrivi il teorema del campionamento in un discorso che ne esponga le formule e le finalità. [5/30]

```
il teorema del campionamento serve per definire la minima frequenza che serve peer campionare un segnale senza perderne informazioni e per ricostruirlo
...
import("stdfaust.lib");
process = _*(0.5),*(0.25),*(0.125),*(0.1) <:_,_,_,_,_*(2),_*(4),*(8),_*(10);
